...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	func configureTabBar() {
		...
		visualEffectView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 49)
		tabBarAppearance.backgroundEffect = (visualEffectView.effect as! UIBlurEffect)
